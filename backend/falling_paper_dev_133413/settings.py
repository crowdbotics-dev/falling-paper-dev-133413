"""
Django settings for falling_paper_dev_133413 project.
...
ROOT_URLCONF = 'falling_paper_dev_133413.urls'
...
WSGI_APPLICATION = 'falling_paper_dev_133413.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_paper_dev_133413 API",
    "DESCRIPTION": "API documentation for falling_paper_dev_133413 App",
    "VERSION": "v1",
}
